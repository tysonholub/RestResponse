...
```
### Unicode
Unicode properties in Python 2.7 that fall outside the ASCII encoder range will be utf-8 encoded and prefixed with `__unicode__: `
```python
>>> import RestResponse
>>> data = RestResponse.parse({
...     'unicode': u'\U0001f44d',
